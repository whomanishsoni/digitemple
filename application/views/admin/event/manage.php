...
<div class="container  content-area">
    <div class="section">
        <div class="page-header">
            ...
            <div class="ml-auto">
                <a href="<?php echo base_url('admin/add-event'); ?>" class="btn btn-primary btn-icon btn-sm text-white mr-2"> <span> <i class="fa fa-plus"></i> </span> <?php echo dt_translate('add') . " " . dt_translate('event'); ?> </a>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered text-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo dt_translate('event')." ".dt_translate('date') ?></th>
                                    <th><?php echo dt_translate('venue') ?></th>
                                ...
                                <?php if (isset($app_events) && count($app_events) > 0): ?>
                                    ...
                                    foreach ($app_events as $val):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo date('m-d-Y',strtotime($val['event_date'])); ?>
                                            </td>
                                            <td><?php echo escape_data($val['event_venue']); ?></td>
                                            <td><?php echo $status; ?></td>
                                            <td><?php echo get_formated_date($val['created_on']); ?></td>
                                            <td class="text-center">
                                                <a href="<?php echo base_url('admin/update-event/' . $val['event_id']); ?>" class="btn btn-primary btn-sm"><?php echo dt_translate('update') ?></a>
                                                <a href="javascript:void(0)" data-action="delete-event" data-toggle="modal" onclick='DeleteConfirm(this)' data-target="#delete-record" data-id="<?php echo (int) $val['event_id']; ?>"  class="btn btn-danger btn-sm"><?php echo dt_translate('delete') ?></a>
                                            </td>
                                        </tr>
