...
<div class="container  content-area">
    <div class="section">
        <div class="page-header">
            ...
            <div class="ml-auto">
                <a href="<?php echo base_url('admin/add-news'); ?>" class="btn btn-primary btn-icon btn-sm text-white mr-2"> <span> <i class="fa fa-plus"></i> </span> <?php echo dt_translate('add') . " " . dt_translate('news'); ?> </a>
            </div>
        </div>
                                    ...
                                    foreach ($app_news as $val):
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url('admin/update-news/' . $val['id']); ?>" class="btn btn-primary btn-sm"><?php echo dt_translate('update') ?></a>
                                                <a href="javascript:void(0)" data-action="delete-news" data-toggle="modal" onclick='DeleteConfirm(this)' data-target="#delete-record" data-id="<?php echo (int) $val['id']; ?>"  class="btn btn-danger btn-sm"><?php echo dt_translate('delete') ?></a>
                                            </td>
                                        </tr>
