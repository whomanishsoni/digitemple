...
$cause_title = isset($app_news['title']) ? escape_data($app_news['title']) : set_value('title');
$description = isset($app_news['description']) ? $app_news['description']: set_value('description');
$id = isset($app_news['id']) ? $app_news['id'] : set_value('id');
$status = isset($app_news['status']) ? $app_news['status'] : 'A';

$logo_check=false;
if (isset($app_news['image']) && $app_news['image']!= "") {
    if (file_exists(FCPATH .uploads_path.'/'. $app_news['image'])) {
        $logo_check = true;
        $image_path = base_url() . uploads_path . '/' . $app_news['image'];
    } else {
    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('admin/manage-news'); ?>"><?php echo dt_translate('manage') . " " . dt_translate('news') ?></a></li>
            </ol>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        echo form_open_multipart('admin/save-news', $attributes);
                        ?>
                        <?php $this->load->view('message'); ?>
                        <input type="hidden" id="id" name="id" value="<?php echo isset($id) ? $id : 0; ?>"/>
                        <input type="hidden" name="old_image" value="<?php echo isset($app_news['image']) ? $app_news['image'] : ""; ?>"/>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="file-field mb-2">
                                        <input class="form-control" onchange="readURL(this)" id="imageurl" <?php if ($logo_check == false) echo "required"; ?>  type="file" name="news_image" accept="image/x-png,image/gif,image/jpeg,image/png"  extension="jpg|png|gif|jpeg" />
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <a tabindex="10" href="<?php echo base_url('admin/manage-news'); ?>" class="btn btn-warning"><?php echo dt_translate('cancel') ?></a>
