...
$dep_title = isset($item_data['title']) ? ($item_data['title']) : set_value('title');
$status = isset($item_data['status']) ? $item_data['status'] : 'A';
$id = isset($item_data['id']) ? (int) $item_data['id'] : (int) set_value('id');
?>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <?php echo ($id > 0) ? dt_translate('update') : dt_translate('add'); ?> <?php echo dt_translate('item'); ?>
                    </div>
                    <div class="card-body">
                        <?php
                        $attributes = array('class' => 'col-md-12 mx-auto', 'id' => 'Save_Form', 'name' => 'Save_Form', 'method' => "post");
                        echo form_open('admin/save-item', $attributes);
                        ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <a href="<?php echo base_url('admin/items'); ?>" class="btn btn-warning"><?php echo dt_translate('cancel') ?></a>
