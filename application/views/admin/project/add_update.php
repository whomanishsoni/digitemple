...
$cause_title = isset($app_projects['title']) ? escape_data($app_projects['title']) : set_value('title');
$description = isset($app_projects['description']) ? $app_projects['description']: set_value('description');
$id = isset($app_projects['id']) ? $app_projects['id'] : set_value('id');
$status = isset($app_projects['status']) ? $app_projects['status'] : 'A';

$logo_check=false;
if (isset($app_projects['image']) && $app_projects['image']!= "") {
    if (file_exists(FCPATH .uploads_path.'/'. $app_projects['image'])) {
        $logo_check = true;
        $image_path = base_url() . uploads_path . '/' . $app_projects['image'];
    } else {
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        echo form_open_multipart('admin/save-project', $attributes);
                        ?>
                        <?php $this->load->view('message'); ?>
                        <input type="hidden" id="id" name="id" value="<?php echo isset($id) ? $id : 0; ?>"/>
                        <input type="hidden" name="old_image" value="<?php echo isset($app_projects['image']) ? $app_projects['image'] : ""; ?>"/>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="file-field mb-2">
                                        <input class="form-control" onchange="readURL(this)" id="imageurl" <?php if ($logo_check == false) echo "required"; ?>  type="file" name="project_image" accept="image/x-png,image/gif,image/jpeg,image/png"  extension="jpg|png|gif|jpeg" />
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <a tabindex="10" href="<?php echo base_url('admin/manage-projects'); ?>" class="btn btn-warning"><?php echo dt_translate('cancel') ?></a>
