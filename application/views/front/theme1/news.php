        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo base_url(); ?>"><?php echo dt_translate('home') ?></a></span> <span><?php echo dt_translate('news') ?></span></p>
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo dt_translate('news') ?></h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container padding_top_7">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb_background">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo dt_translate('news') ?></li>
            </ol>
        </nav>
    </div>
<?php endif; ?>
                    ...
                    <?php foreach ($app_news as $val):
                        ...
                        <div class="col-md-4 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch">
                                <a href="<?php echo base_url('news-details/'.$val['id']); ?>" class="block-20" style="background-image: url('<?php echo $image_path; ?>');"></a>
                                <div class="text p-4 d-block">
                                    <div class="meta mb-3">
                                        <div><a href="<?php echo base_url('news-details/'.$val['id']); ?>"><?php echo date('M d, Y',strtotime($val['created_on'])); ?></a></div>
                                        <div><a href="<?php echo base_url('news-details/'.$val['id']); ?>"><?php echo $val['first_name']." ".$val['last_name']; ?></a></div>
                                    </div>
                                    <h3 class="heading mt-3"><a href="<?php echo base_url('news-details/'.$val['id']); ?>"><?php echo escape_data($val['title']); ?></a></h3>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
